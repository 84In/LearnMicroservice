package com.trungtin.notificationservice.event;

import com.trungtin.commonservice.services.EmailService;
...
public class EventConsumer {
    ...
    public void testEmail(String message) {
        ...
        String template = "<div>\n" +
                ...
                "</div>";
        String filledTemplate = String.format(template, "Trung Tin", message);

        emailService.sendEmail(message, "Thank for buy my course", filledTemplate, true, null);
    }
